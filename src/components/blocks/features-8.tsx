...
// Animated counter hook with looping
function useCounter(end: number, duration: number = 2000, pauseDuration: number = 2000) {
        ...
        const runAnimation = () => {
            ...
            const animate = (currentTime: number) => {
                ...
                if (progress < 1) {
                    ...
                    // Hold at end value, then reset and loop
                    timeoutId = setTimeout(() => {
                        setCount(0)
                        setTimeout(runAnimation, 300) // Brief pause before restarting
                    }, pauseDuration)
                }
            }
            animationId = requestAnimationFrame(animate)
    ...
    }, [end, duration, pauseDuration, isInView])
        ...
        <section className="bg-gray-50 py-16 md:py-32 dark:bg-transparent">
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                ...
                <div className="text-center mb-16">
                    <p className="text-sm font-bold tracking-widest text-primary uppercase mb-4">WHY VOICE AI</p>
                    <h2 className="text-4xl md:text-5xl font-semibold tracking-tight text-zinc-900 dark:text-white mb-6">
                        The <span className="text-primary">competitive edge</span> your<br className="hidden md:block" /> business needs
                    </h2>
                    <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
                        Voice AI agents deliver measurable results—from cost savings to customer satisfaction. Here&apos;s what the data shows.
                    </p>
                </div>
    ...
    return (
        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
            <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center" ref={ref}>
                ...
                <h3 className="mt-6 text-center text-3xl font-semibold tracking-tight">Availability</h3>
                <p className="mt-2 text-center text-sm text-zinc-500">Never miss a call, even at 3 AM</p>
            </CardContent>
        </Card>
    )
}
    ...
    return (
        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
            <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5" ref={ref}>
                    <svg className="m-auto h-fit w-24" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_0_1" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                                ...
                                <stop offset="1" stopColor="#F25C22" />
                            </linearGradient>
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                    <h3 className="group-hover:text-secondary-950 text-lg font-semibold tracking-tight transition dark:text-white">Enterprise Security</h3>
                    <p className="text-foreground">SOC 2 compliant with end-to-end encryption. Your customer data stays protected at every touchpoint.</p>
                </div>
            </CardContent>
        </Card>
    )
...
function ResponseTimeCard() {
    const ref = useRef(null)
    const isInView = useInView(ref, { once: false, margin: "-100px" })
    const { count: mbps, ref: mbpsRef } = useCounter(1434, 2000, 2500)

    return (
        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
            <CardContent className="pt-6">
                <div className="pt-6 lg:px-6 relative" ref={ref}>
                    {/* Animated mbps counter overlay */}
                    <div className="absolute top-6 right-0 lg:right-6 text-sm font-medium">
                        <span ref={mbpsRef} className="text-[#F25C22] font-semibold">{mbps}</span> <span className="text-muted-foreground">mbps</span>
                    </div>
                    <svg className="dark:text-muted-foreground w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g clipPath="url(#clip0_0_106)">
                            ...
                            <text x="55" y="32" fill="currentColor" fontSize="14" fontFamily="system-ui">
                                Download
                            </text>
                        </g>
                        <path
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#F25C22" stopOpacity="0.35" />
                                <stop offset="1" stopColor="#F25C22" stopOpacity="0.1" />
                            </linearGradient>
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                    <h3 className="text-lg font-semibold tracking-tight transition">&lt;500ms Response Time</h3>
                    <p className="text-foreground">Human-like conversation speed with sub-second latency. No awkward pauses or delays.</p>
                </div>
            </CardContent>
        </Card>
    )
            ...
            <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    ...
                    <div className="space-y-2">
                        <h3 className="group-hover:text-secondary-950 text-lg font-semibold tracking-tight text-zinc-800 transition dark:text-white">80% Cost Reduction</h3>
                        <p className="text-foreground">Cut customer support costs dramatically while scaling to handle unlimited concurrent calls.</p>
                    </div>
                </div>
                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6" ref={ref}>
                    ...
                    <svg className="w-full sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_0_705" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#F25C22" stopOpacity="0.35" />
                                <stop offset="1" stopColor="#F25C22" stopOpacity="0.01" />
                            </linearGradient>
                        </defs>
                    </svg>
                </div>
...
function LeadConversionCard() {
    const { count: leads1, ref: ref1 } = useCounter(127, 2000, 2500)
    const { count: leads2, ref: ref2 } = useCounter(89, 1800, 2700)
    const { count: leads3, ref: ref3 } = useCounter(203, 2200, 2300)
    ...
    return (
        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                        <TrendingUp className="m-auto size-6" strokeWidth={1} />
                    </div>
                    <div className="space-y-2">
                        <h3 className="text-lg font-semibold tracking-tight transition">3x Higher Lead Conversion</h3>
                        <p className="text-foreground">Instant follow-ups and personalized conversations turn more prospects into paying customers.</p>
                    </div>
                </div>
                    ...
                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                        ...
                        >
                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">
                                +<span ref={ref1} className="text-[#F25C22] font-semibold">{leads1}</span> leads
                            </span>
                        ...
                        >
                            ...
                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">
                                +<span ref={ref2} className="text-[#F25C22] font-semibold">{leads2}</span> leads
                            </span>
                        </motion.div>
                        <motion.div
                            className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2"
                        ...
                        >
                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">
                                +<span ref={ref3} className="text-[#F25C22] font-semibold">{leads3}</span> leads
                            </span>
                            <div className="ring-background size-7 ring-4">
